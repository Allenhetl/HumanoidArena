...
# run_task sonic "${ISAACLAB_ROOT}/${ISAACLAB_ROOT}/script/eval_scripts/sonic/run_vla_eval_parallel.sh
# run_task twist2 "${ISAACLAB_ROOT}/${ISAACLAB_ROOT}/script/eval_scripts/twist2/run_vla_eval_parallel.sh
