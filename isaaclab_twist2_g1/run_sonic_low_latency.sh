...
SONIC_ENCODER_PATH="${SONIC_ENCODER_PATH:-${SONIC_LOW_LATENCY_POLICY_ROOT}/model_encoder.onnx}"
SONIC_DECODER_PATH="${SONIC_DECODER_PATH:-${SONIC_LOW_LATENCY_POLICY_ROOT}/model_decoder.onnx}"
...
RECORDING_SAVE_DIR="${SCRIPT_DIR}/recording_data/HSI_boxing/sonic_low_latency/yb"
...
echo "[sonic_low_latency] task=${TASK_NAME}"
echo "[sonic_low_latency] env_config=${ENV_CONFIG_YAML}"
echo "[sonic_low_latency] seed=${SEED}"
echo "[sonic_low_latency] encoder=${SONIC_ENCODER_PATH}"
echo "[sonic_low_latency] decoder=${SONIC_DECODER_PATH}"
