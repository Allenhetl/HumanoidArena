...
ENV_CONFIG_YAML="${SONIC_CONFIG}"   run_task sonic script/eval_scripts/sonic/HSI_open_door_run_vla_eval_parallel.sh
ENV_CONFIG_YAML="${TWIST2_CONFIG}"  run_task twist2 script/eval_scripts/twist2/HSI_open_door_run_vla_eval_parallel.sh
