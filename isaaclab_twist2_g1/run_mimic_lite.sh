...
ENV_CONFIG_YAML="${ENV_CONFIG_YAML:-${ISAACLAB_ROOT}/tasks/common_env_config/football_single_sonic.yaml}"
...
# RECORDING_SAVE_DIR="${RECORDING_SAVE_DIR:-${SCRIPT_DIR}/recording_data/HSI_open_door/mimic_lite/zz}"
RECORDING_SAVE_DIR="${RECORDING_SAVE_DIR:-${SCRIPT_DIR}/recording_data/HOI_football/mimic_lite/zz}"
...
SIM_LOG="${LOG_DIR}/sim_main_mimic_lite_${RUN_TS}.log"
...
{
  echo "[$(date '+%F %T')] Starting MimicLite run"
...
# Common alternatives:
# Open door: tasks/common_env_config/opendoor_sonic.yaml
# Boxing bag: tasks/common_env_config/boxing_bag_sonic.yaml
# Football: tasks/common_env_config/football_single_sonic.yaml
# Double desk: tasks/common_env_config/doubledesk_sonic.yaml
# Pick place box: tasks/common_env_config/pickplace_box_sonic.yaml
