...
# TEST_MODE=base_test EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_opendoor_0421_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_base bash pi05_batch_test_open_door.sh
# TEST_MODE=semantic EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_opendoor_0421_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_semantic bash pi05_batch_test_open_door.sh
# TEST_MODE=vision EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_opendoor_0421_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_vision bash pi05_batch_test_open_door.sh
# TEST_MODE=execution EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_opendoor_0421_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_execution bash pi05_batch_test_open_door.sh


# TEST_MODE=base_test EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_sitsofa_0423_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_base bash pi05_batch_test_sit_sofa.sh
# TEST_MODE=semantic EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_sitsofa_0423_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_semantic bash pi05_batch_test_sit_sofa.sh
# TEST_MODE=vision EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_sitsofa_0423_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_vision bash pi05_batch_test_sit_sofa.sh
# TEST_MODE=execution EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_sitsofa_0423_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_execution bash pi05_batch_test_sit_sofa.sh


# TEST_MODE=base_test EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_visionnavi_0419_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_base bash pi05_batch_test_vision_navi.sh
# TEST_MODE=semantic EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_visionnavi_0419_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_semantic bash pi05_batch_test_vision_navi.sh
# TEST_MODE=vision EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_visionnavi_0419_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_vision bash pi05_batch_test_vision_navi.sh
# TEST_MODE=execution EVAL_BACKEND=twist2 MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new_100000/pi0.5_100000/Pi0.5_twist2_visionnavi_0419_100000" MODEL_GLOB="*" NUM_WORKERS=2 RESULTS_TAG_PREFIX=pi05_execution bash pi05_batch_test_vision_navi.sh
