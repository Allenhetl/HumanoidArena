...
BATCH_MODEL_ROOT="/ai/Yichi/taowen/ckpts/0424_new/HSI_sit_sofa"
# BATCH_MODEL_ROOT="/ai/Yichi/taowen/ckpts/test/football_supply"
export MODEL_ROOT="${MODEL_ROOT:-${BATCH_MODEL_ROOT}}"

ENV_CONFIG_YAML="${SONIC_CONFIG}"   run_task sonic script/eval_scripts/sonic_pi05/HSI_sit_sofa_run_vla_eval_parallel.sh
ENV_CONFIG_YAML="${TWIST2_CONFIG}"  run_task twist2 script/eval_scripts/twist2_pi05/HSI_sit_sofa_run_vla_eval_parallel.sh
