...
MIMIC_LITE_ONNX_PATH="${MIMIC_LITE_ONNX_PATH:-${RUN_SCRIPT_DIR}/../../assets/checkpoints/mimic_lite/policy-xua2csee-4000.onnx}"
MIMIC_LITE_YAML_PATH="${MIMIC_LITE_YAML_PATH:-${RUN_SCRIPT_DIR}/../../assets/checkpoints/mimic_lite/policy-xua2csee-4000.yaml}"
...
RESULTS_TAG_BASE="${RESULTS_TAG:-1test_HOI_double_desk_sonic_low_latency_low_latency_batch_2000_mix}"
