...
MIMIC_LITE_ONNX_PATH="${MIMIC_LITE_ONNX_PATH:-${ISAACLAB_ROOT}/assets/checkpoints/mimic_lite/policy-xua2csee-4000.onnx}"
MIMIC_LITE_YAML_PATH="${MIMIC_LITE_YAML_PATH:-${ISAACLAB_ROOT}/assets/checkpoints/mimic_lite/policy-xua2csee-4000.yaml}"
[[ -f "${MIMIC_LITE_ONNX_PATH}" ]] || { echo "Error: MimicLite ONNX not found: ${MIMIC_LITE_ONNX_PATH}" >&2; exit 2; }
[[ -f "${MIMIC_LITE_YAML_PATH}" ]] || { echo "Error: MimicLite YAML not found: ${MIMIC_LITE_YAML_PATH}" >&2; exit 2; }
