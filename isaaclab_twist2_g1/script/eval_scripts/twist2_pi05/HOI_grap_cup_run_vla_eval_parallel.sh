...
export ENV_CONFIG_YAML="${ENV_CONFIG_YAML:-tasks/common_test_config/base_test/grap_cup_twist2_test.yaml}"
RESULTS_TAG_BASE="${RESULTS_TAG:-HOI_grap_cup_twist2_batch_2000_mix}"
