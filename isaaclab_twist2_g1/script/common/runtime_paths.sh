...
SONIC_LOW_LATENCY_POLICY_ROOT="${SONIC_LOW_LATENCY_POLICY_ROOT:-${GROOT_ROOT}/gear_sonic_deploy/policy/low_latency}"
...
export ISAACLAB_ROOT HUMANOIDARENA_ROOT TWIST2_ROOT LEROBOT_ROOT GROOT_ROOT SONIC_POLICY_ROOT SONIC_LOW_LATENCY_POLICY_ROOT
